...
const CANONICAL_SOURCE = 'https://github.com/DevPathAi/devpath-gateway';
const CANONICAL_REPOSITORY = 'DevPathAi/devpath-gateway';
const CANONICAL_IMAGE = 'ghcr.io/devpathai/devpath-gateway';
