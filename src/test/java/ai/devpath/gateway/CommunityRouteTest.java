...
class CommunityRouteTest {
  ...
  @Test
  void communityQuestionsRequireJwt() {
    web.post().uri("/community/questions").exchange()
        .expectStatus().isUnauthorized();
  }

  @Test
  void authenticatedCommunityRequestMatchesRoute() {
    web.post().uri("/community/questions")
        .header(HttpHeaders.AUTHORIZATION, "Bearer test-token")
        .exchange()
        .expectStatus().value(CommunityRouteTest::assertGatewayMatchedRoute);
  }
