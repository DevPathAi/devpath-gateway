...
class LearningPathRouteTest {
  ...
  @Test
  void currentPathRequiresJwt() {
    web.get().uri("/learning-paths/me").exchange()
        .expectStatus().isUnauthorized();
  }

  @Test
  void generatePathRequiresJwt() {
    web.post().uri("/learning-paths/me/generate").exchange()
        .expectStatus().isUnauthorized();
  }

  @Test
  void authenticatedCurrentPathMatchesLearningRoute() {
    web.get().uri("/learning-paths/me")
